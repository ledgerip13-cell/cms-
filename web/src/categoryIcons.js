...
const CATEGORY_ICON_KEYS = new Set([
  'action', 'adventure', 'anime', 'calendar', 'car', 'cinema', 'classic', 'collection', 'comedy', 'comic',
  'commentary', 'crime', 'diamond', 'documentary', 'education', 'fashion', 'film',
  'folder', 'food', 'game', 'grid', 'health', 'heart', 'history', 'hot', 'kids', 'live',
  'magic', 'movie', 'music', 'mystery', 'news', 'play', 'podcast', 'radio', 'ranking',
  'recommend', 'romance', 'science', 'search', 'series', 'shortplay', 'sport', 'stage', 'star', 'travel',
  'trophy', 'tv', 'update', 'variety', 'war',
])
