...
.auth-fade-enter-active, .auth-fade-leave-active { transition: opacity .12s ease; will-change: opacity; }
.auth-fade-enter-from, .auth-fade-leave-to { opacity: 0; }
.auth-fade-enter-active .auth-modal,
.auth-fade-leave-active .auth-modal { transition: transform .16s cubic-bezier(.2,.7,.2,1), opacity .16s ease; will-change: transform, opacity; backface-visibility: hidden; }
