...
export const api = {
  ...
  previewPlaybackDiagnose: (d) => http.post('/admin/vods/play-diagnose/preview', d),
  executePlaybackDiagnose: (d) => http.post('/admin/vods/play-diagnose/execute', d),
  deleteVodImage: (vodId, imageId) => http.delete(`/admin/vods/${vodId}/images/${imageId}`),
