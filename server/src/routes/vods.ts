    ...
    secured.get("/api/admin/vods/:id/diagnose", async (req, reply) => {
      ...
      return {
        ...
        jinpaiStatus: result?.rule === "jinpai_client" ? {
          ...
          clientCountry: result?.jinpai?.clientCountry || "",
          clientRegion: result?.jinpai?.clientRegion || "",
          cdnHost: result?.jinpai?.cdnHost || "",
          cdnRegion: result?.jinpai?.cdnRegion || "",
          retryCdnHost: result?.jinpai?.retryCdnHost || "",
          retryCdnRegion: result?.jinpai?.retryCdnRegion || "",
          regionMismatch: Boolean(result?.jinpai?.regionMismatch),
