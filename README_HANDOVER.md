...
> **最后更新**：2026-07-11 (GMT+8)｜**对应提交**：本提交（移动剧场与刷剧全集态视觉微调）
...
- **2026-07-11 视觉断点**：移动剧场默认“全部影片”列表首屏只取 3 条，进入分类/搜索/年份筛选后仍按 24 条分页；剧场筛选抽屉的点击遮罩保留但去掉黑色蒙版；刷剧全集态顶部降低黑色渐变蒙版，返回/集数/搜索/更多改为轻微高斯感 drop-shadow 与淡 shadow，不再像黑底按钮。
